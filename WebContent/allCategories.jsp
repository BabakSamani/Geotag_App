					...
					<table class="table table-striped">
					  <thead>
					    <tr>
					      ...
					      <th class="col-xs-4 col-xs-offset-3">File Name/Path</th>
							...
							<c:otherwise>
								...
								<c:forEach var="category" items="${categoryList}">
									...
									<tr>
										...
										<td>
								      		<img class="img-thumbnail" width="20%" height="20%" id="iconImage" src="${category.link}">
									  	</td>
									  	<td>
